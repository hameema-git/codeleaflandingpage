...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hidden SEO H1 — does not change UI */}
      <h1 className="sr-only">
        CodeLeaf — Custom Software, Automation, and Web Development Company in Kochi
      </h1>
      ...
      {/* THE REST OF YOUR PAGE (Why Us, Process, About, Contact, Footer) 
          REMAINS EXACTLY THE SAME — unchanged */}
    </div>
  )
}
