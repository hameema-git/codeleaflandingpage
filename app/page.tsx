...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* 🔥 Hidden SEO H1 (NOT visible to users) */}
      <h1 className="sr-only">CodeLeaf — Custom Software & Web Development in Kochi</h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Users, title: "Training & Mentoring", desc: "Python, Django & Deployment courses" },
            ].map((service, idx) => (
              <div
                key={idx}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Deployments on Render, Railway, Vercel, cPanel & Linux",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 sm:p-12">
            ...
            <p className="text-lg text-foreground/80 mb-4 leading-relaxed">
              ...
              delivers modern custom software, web applications, and automation solutions for institutions, startups,
              and businesses worldwide.
            </p>
            <p className="text-lg text-foreground/80 leading-relaxed">
              With deep expertise in modern frameworks and deployments, we transform challenges into scalable digital
              solutions. Whether expanding globally or starting fresh, we help turn your ideas into reality.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-extrabold text-xl tracking-wide">CODE LEAF</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-primary-foreground/70">
                <li><a href="#services" className="hover:text-primary-foreground transition">Web Development</a></li>
                <li><a href="#services" className="hover:text-primary-foreground transition">Mobile Apps</a></li>
                <li><a href="#services" className="hover:text-primary-foreground transition">Automation</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-primary-foreground/70">
                <li><a href="#why-us" className="hover:text-primary-foreground transition">About Us</a></li>
                <li><a href="#process" className="hover:text-primary-foreground transition">Our Process</a></li>
